...
void Lcd_Init(void){
    ...
    {
        LATDbits.LD7 = 0; LATDbits.LD6 = 0; LATDbits.LD5 = 1; LATDbits.LD4 = 1; LATDbits.LD3 = 0;
        LATDbits.LD2 = 0; LATDbits.LD7 = 0; LATDbits.LD6 = 0; LATDbits.LD5 = 1; LATDbits.LD4 = 1;
        LATDbits.LD3 = 1; LATDbits.LD2 = 0;
        _delay((unsigned long)((5)*(48000000/4000000.0)));
        LATDbits.LD7 = 0; LATDbits.LD6 = 0; LATDbits.LD5 = 1; LATDbits.LD4 = 1; LATDbits.LD3 = 0;
        LATDbits.LD2 = 0;
        _delay((unsigned long)((5500)*(48000000/4000000.0)));
    }
    LATDbits.LD7 = 0; LATDbits.LD6 = 0; LATDbits.LD5 = 1; LATDbits.LD4 = 0; LATDbits.LD3 = 0; LATDbits.LD2 = 0;
    LATDbits.LD7 = 0; LATDbits.LD6 = 0; LATDbits.LD5 = 1; LATDbits.LD4 = 0; LATDbits.LD3 = 1; LATDbits.LD2 = 0;
    _delay((unsigned long)((5)*(48000000/4000000.0)));
    LATDbits.LD7 = 0; LATDbits.LD6 = 0; LATDbits.LD5 = 1; LATDbits.LD4 = 0; LATDbits.LD3 = 0; LATDbits.LD2 = 0;
    _delay((unsigned long)((5500)*(48000000/4000000.0)));
...
void Lcd_Chr_CP(char data){
    ...
    LATDbits.LD5 = (data & 0b00100000)>>5; LATDbits.LD4 = (data & 0b00010000)>>4;
    _delay(10);
    LATDbits.LD3 = 1; _delay((unsigned long)((5)*(48000000/4000000.0))); LATDbits.LD3 = 0;
    LATDbits.LD7 = (data & 0b00001000)>>3; LATDbits.LD6 = (data & 0b00000100)>>2;
    LATDbits.LD5 = (data & 0b00000010)>>1; LATDbits.LD4 = (data & 0b00000001);
    _delay(10);
    LATDbits.LD3 = 1; _delay((unsigned long)((5)*(48000000/4000000.0))); LATDbits.LD3 = 0;
    _delay((unsigned long)((5)*(48000000/4000000.0))); _delay((unsigned long)((5500)*(48000000/4000000.0)));
}
